...
always @(*) begin
    case (lut_index)
        ...
        4'h1: lut_data <= 16'h001F; // left input  ADC gain = +12dB (was +0dB)
        4'h2: lut_data <= 16'h021F; // right input ADC gain = +12dB
        4'h3: lut_data <= 16'h047F; // left output DAC vol = +6dB (was +0dB)
        4'h4: lut_data <= 16'h067F; // right output DAC vol = +6dB
        4'h5: lut_data <= 16'h08d5; // analog path: MICBOOST=1 (+20dB mic preamp)
